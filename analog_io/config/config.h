...
#define MODBUS_ADDR_REGISTER          MODBUS_MAP_HOLDING_REG_DEVICE_ID
...
#define AI_CHANNELS                   MODBUS_MAP_AI_CHANNEL_COUNT
#define AO_CHANNELS                   MODBUS_MAP_AO_CHANNEL_COUNT
